...
namespace TmoTcpServer
{
    public partial class UcTcpServer : UserControl
    {
        ...
        public static UcTcpServer Instance
        {
            ...
            set { UcTcpServer._instance = value; }
        }
        ...
        public bool StartServeice()
        {
            ...
            if (TCPServer.Instance.Running)
            {
                ...
                LogHelper.Log.Info("消息" + lblServerAddr.Text + lblStatus.Text);
            }
            else
            {
                LogHelper.Log.Info("消息服务器" + _tcpServerIP + ":" + _tcpServerPort + "启动失败");
            }
        ...
        public bool StopService()
        {
            ...
            if (!TCPServer.Instance.Running)
            {
                ...
                LogHelper.Log.Info("消息服务器" + _tcpServerIP + ":" + _tcpServerPort + "停止成功");
            }
            else
            {
                LogHelper.Log.Info("消息服务器" + _tcpServerIP + ":" + _tcpServerPort + "停止失败");
            }
