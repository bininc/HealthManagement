...
namespace DBDAL.MySqlDal
{
    public class tmo_pointsDal : Itmo_points
    {
        ...
        public bool CreatePointsUser(string user_id)
        {
            ...
            sqlinsert.Append(" values ");
            sqlinsert.Append("('" + detialID + "','" + user_id + "','1000010','" + pointsNum + "','1','','" + datetime + "','" + GetPointsNote("1000010") + "','2','1')");
            SQLList.Add(sqlinsert.ToString());
            sqlinsert.Remove(0, sqlinsert.Length);
        ...
        public string SignDayly(string user_id)
        {
            ...
            sqlinsert.Append("(detail_id,user_id,goods_id,code_num,status,expire_date,input_time,note,is_del,source_id)");
            sqlinsert.Append(" values ");
            sqlinsert.Append("('" + TmoShare.NextBillNumber() + "','" + user_id + "','1000020','" + pointsNum + "','1','','" + datetime + "','" + GetPointsNote("1000020") + "','2','1')");
            SQLList.Add(sqlinsert.ToString());
            sqlinsert.Remove(0, sqlinsert.Length);
            /*3修改积分信息*/
        ...
        public string AddNurDiary(DataSet dsNurDiary)
        {
            ...
            //验证今天是否添加
            string sqltoday = "select diary_date,user_id from tmo_nur_diary where  user_id='" + drNruDiary["user_id"] + "' and  diary_date='" + drNruDiary["diary_date"] + " 00:00:00'";
            DataSet ds = MySQLHelper.Query(sqltoday);
            //if (TmoShare.DataSetIsNotEmpty(ds)) return "-3";
            //查询积分信息
            ...
            if (TmoShare.DataSetIsEmpty(ds))
            {
                ...
                sqlinsert.Append("(nur_guid,diary_date,user_id,diary_content,staple_food,coarse_food,vegetable,fruit,nut,pickles,cure,fry,soy_salt,cook,meal_num,points,input_time,is_del)");
                sqlinsert.Append(" values ");
                ...
                if (!dsNurDiary.Tables[0].Columns.Contains("is_client"))
                {
                    if (drNruDiary["diary_date"].ToString() == DateTime.Now.ToString("yyyy-MM-dd"))
                    {
                        ...
                        sqlinsert.Append("(detail_id,user_id,goods_id,code_num,status,expire_date,input_time,note,is_del,source_id)");
                        sqlinsert.Append(" values ");
                        sqlinsert.Append("('" + TmoShare.NextBillNumber() + "','" + drNruDiary["user_id"].ToString() + "','1000050','" + drNruDiary["points"] + "','1','','" + datetime + "','" + GetPointsNote("1000050") + "','2','1')");
                        SQLList.Add(sqlinsert.ToString());
                        sqlinsert.Remove(0, sqlinsert.Length);
                        /*3修改积分信息*/

                        sqlinsert.Append("update  tmo_points  set ");
                        sqlinsert.Append(" code_num='" + (Convert.ToInt32(drNruDiary["points"].ToString()) + Convert.ToInt32(dspoints.Tables[0].Rows[0]["code_num"].ToString())).ToString() + "',");
                        sqlinsert.Append(" gain_num='" + (Convert.ToInt32(drNruDiary["points"].ToString()) + Convert.ToInt32(dspoints.Tables[0].Rows[0]["gain_num"].ToString())).ToString() + "',");
                        sqlinsert.Append(" update_time='" + datetime + "'");
        ...
        public string AddSportDiary(DataSet dsSportDiary)
        {
            ...
            //验证今天是否添加
            string sqltoday = "select diary_date,user_id from tmo_sport_diary where  user_id='" + drSportDiary["user_id"] + "' and  diary_date='" + drSportDiary["diary_date"] + " 00:00:00'";
            DataSet ds = MySQLHelper.Query(sqltoday);
            //if (TmoShare.DataSetIsNotEmpty(ds)) return "-3";
            //查询积分信息
            ...
            if (TmoShare.DataSetIsEmpty(ds))
            {
                ...
                if (!dsSportDiary.Tables[0].Columns.Contains("is_client"))
                {
                    if (drSportDiary["diary_date"].ToString() == DateTime.Now.ToString("yyyy-MM-dd"))
                    {
                        ...
                        sqlinsert.Append("(detail_id,user_id,goods_id,code_num,status,expire_date,input_time,note,is_del,source_id)");
                        sqlinsert.Append(" values ");
                        sqlinsert.Append("('" + TmoShare.NextBillNumber() + "','" + drSportDiary["user_id"].ToString() + "','1000060','" + drSportDiary["points"] + "','1','','" + datetime + "','" + GetPointsNote("1000060") + "','2','1')");
                        SQLList.Add(sqlinsert.ToString());
                        sqlinsert.Remove(0, sqlinsert.Length);
                        /*3修改积分信息*/

                        sqlinsert.Append("update  tmo_points  set ");
                        sqlinsert.Append(" code_num='" + (Convert.ToInt32(drSportDiary["points"].ToString()) + Convert.ToInt32(dspoints.Tables[0].Rows[0]["code_num"].ToString())).ToString() + "',");
                        sqlinsert.Append(" gain_num='" + (Convert.ToInt32(drSportDiary["points"].ToString()) + Convert.ToInt32(dspoints.Tables[0].Rows[0]["gain_num"].ToString())).ToString() + "',");
                        sqlinsert.Append(" update_time='" + datetime + "'");
        ...
        public string AddManagement(DataSet dsManagement)
        {
            ...
            sqlinsert.Append(" values ");
            sqlinsert.Append("('" + Guid.NewGuid().ToString("N") + "','" + drSportDiary["user_id"] + "','" + drSportDiary["management_content"] + "','" + datetime + "','2')");
            SQLList.Add(sqlinsert.ToString());
            sqlinsert.Remove(0, sqlinsert.Length);
            if (TmoShare.DataSetIsEmpty(ds))
            {
                ...
                sqlinsert.Append("(detail_id,user_id,goods_id,code_num,status,expire_date,input_time,note,is_del,source_id)");
                sqlinsert.Append(" values ");
                sqlinsert.Append("('" + TmoShare.NextBillNumber() + "','" + drSportDiary["user_id"].ToString() + "','1000070','" + pointsNum + "','1','','" + datetime + "','" + GetPointsNote("1000070") + "','2','1')");
                SQLList.Add(sqlinsert.ToString());
                sqlinsert.Remove(0, sqlinsert.Length);
                /*3修改积分信息*/
        ...
        public string AddTargetDiary(DataSet dsTargetDiary)
        {
            ...
            //验证今天是否添加
            string sqltoday = "select diary_date,user_id from tmo_target_diary where  user_id='" + drTargetDiary["user_id"] + "' and  diary_date='" + drTargetDiary["diary_date"] + " 00:00:00'";
            DataSet ds = MySQLHelper.Query(sqltoday);
            if (TmoShare.DataSetIsNotEmpty(ds)) return "-3";
            //查询积分信息
            ...
            sqlinsert.Append("(target_guid,diary_date,user_id,diary_content,fbg,pbg,ghb,chol,trig,hdl,ldl,dbp,sbp,bmi,mau,aerobics,hcy,is_hbp,is_chd,points,input_time,is_del)");
            sqlinsert.Append(" values ");
            sqlinsert.Append("('" + Guid.NewGuid().ToString("N") + "','" + drTargetDiary["diary_date"] + "','" + drTargetDiary["user_id"] + "','" + drTargetDiary["diary_content"]
                               + "','" + drTargetDiary["fbg"] + "','" + drTargetDiary["pbg"] + "','" + drTargetDiary["ghb"] + "','" + drTargetDiary["chol"] + "','" + drTargetDiary["trig"] + "','" + drTargetDiary["hdl"] + "','"
                               + drTargetDiary["ldl"] + "','" + drTargetDiary["dbp"] + "','" + drTargetDiary["sbp"] + "','" + drTargetDiary["bmi"] + "','" + drTargetDiary["mau"] + "','" + drTargetDiary["aerobics"] + "','" + drTargetDiary["hcy"] + "','" + drTargetDiary["is_hbp"] + "','" + drTargetDiary["is_chd"] + "','" + drTargetDiary["points"] + "','" + datetime + "','2')");
            SQLList.Add(sqlinsert.ToString());
            sqlinsert.Remove(0, sqlinsert.Length);
            if (!dsTargetDiary.Tables[0].Columns.Contains("is_client"))
            {
                if (drTargetDiary["diary_date"].ToString() == DateTime.Now.ToString("yyyy-MM-dd"))
                {
                    ...
                    sqlinsert.Append("(detail_id,user_id,goods_id,code_num,status,expire_date,input_time,note,is_del,source_id)");
                    sqlinsert.Append(" values ");
                    sqlinsert.Append("('" + TmoShare.NextBillNumber() + "','" + drTargetDiary["user_id"].ToString() + "','1000090','" + drTargetDiary["points"] + "','1','','" + datetime + "','" + GetPointsNote("1000090") + "','2','1')");
                    SQLList.Add(sqlinsert.ToString());
                    sqlinsert.Remove(0, sqlinsert.Length);
                    /*3修改积分信息*/

                    sqlinsert.Append("update  tmo_points  set ");
                    sqlinsert.Append(" code_num='" + (Convert.ToInt32(drTargetDiary["points"].ToString()) + Convert.ToInt32(dspoints.Tables[0].Rows[0]["code_num"].ToString())).ToString() + "',");
                    sqlinsert.Append(" gain_num='" + (Convert.ToInt32(drTargetDiary["points"].ToString()) + Convert.ToInt32(dspoints.Tables[0].Rows[0]["gain_num"].ToString())).ToString() + "',");
                    sqlinsert.Append(" update_time='" + datetime + "'");
        ...
        public string AddTargetAppend(DataSet dsTargetDiary)
        {
            ...
            DataRow drTargetDiary = dsTargetDiary.Tables[0].Rows[0];
            //验证今天是否添加
            string sqltoday = "select diary_date, user_id from tmo_target_append where  user_id='" + drTargetDiary["user_id"] + "' and  diary_date='" + drTargetDiary["diary_date"] + " 00:00:00'";
            DataSet ds = MySQLHelper.Query(sqltoday);
            //if (TmoShare.DataSetIsNotEmpty(ds)) return "-3";
            //查询积分信息
            DataSet dspoints = GetPointsDate(drTargetDiary["user_id"].ToString());
            ...
            if (TmoShare.DataSetIsEmpty(ds))
            {
                ...
                sqlinsert.Append("(target_guid,diary_date,user_id,diary_content,xuetang_kf,xuetang_zaoch,xuetang_wucq,xuetang_wuch,xuetang_wancq,xuetang_wanch,xuetang_sq,xuetang_lc,xueya_zc,xueya_sw,xueya_zw,xueya_xw,xueya_sq,ghbaic,points,input_time,is_del)");
                sqlinsert.Append(" values ");
                sqlinsert.Append("('" + Guid.NewGuid().ToString("N") + "','" + drTargetDiary["diary_date"] + "','" + drTargetDiary["user_id"] + "','" + drTargetDiary["diary_content"]
        ...
        public string AddPharmacyRecord(DataSet dsPharmacyRecord)
        {
            ...
            //验证今天是否添加
            string sqltoday = "select diary_date, user_id from tmo_pharmacy_record where  user_id='" + drTargetDiary["user_id"] + "' and  diary_date='" + drTargetDiary["diary_date"] + " 00:00:00'";
            DataSet ds = MySQLHelper.Query(sqltoday);
            //if (TmoShare.DataSetIsNotEmpty(ds)) return "-3";
            //查询积分信息
            DataSet dspoints = GetPointsDate(drTargetDiary["user_id"].ToString());
            ...
            if (TmoShare.DataSetIsEmpty(ds))
            {
                ...
                sqlinsert.Append("(pharmacy_guid,diary_date,user_id,diuretic,a_blockers,b_blockers,ace_inhibitor,angr_inhibitor,ccb,else_pressure,statins,fibrates,bas,hydrochloride,fatty_acid,else_fibrate,su,agis,benzoic,biguanides,euglycemic_agent,else_antidiabetic,points,input_time,is_del,diary_content)");
                sqlinsert.Append(" values ");
                sqlinsert.Append("('" + Guid.NewGuid().ToString("N") + "','" + drTargetDiary["diary_date"] + "','" + drTargetDiary["user_id"]
                                   + "','" + drTargetDiary["diuretic"] + "','" + drTargetDiary["a_blockers"] + "','" + drTargetDiary["b_blockers"] + "','" + drTargetDiary["ace_inhibitor"] + "','" + drTargetDiary["angr_inhibitor"] + "','" + drTargetDiary["ccb"] + "','"
                                   + drTargetDiary["else_pressure"] + "','" + drTargetDiary["statins"] + "','" + drTargetDiary["fibrates"] + "','" + drTargetDiary["bas"] + "','" + drTargetDiary["hydrochloride"] + "','" + drTargetDiary["fatty_acid"] + "','" + drTargetDiary["else_fibrate"] + "','" + drTargetDiary["su"] + "','" + drTargetDiary["agis"] + "','" + drTargetDiary["benzoic"] +
                                   "','" + drTargetDiary["biguanides"] + "','" + drTargetDiary["euglycemic_agent"] + "','" + drTargetDiary["else_antidiabetic"] + "','" + pointsNum + "','" + datetime + "','2','" + drTargetDiary["diary_content"] + "')");
                SQLList.Add(sqlinsert.ToString());
                sqlinsert.Remove(0, sqlinsert.Length);
                if (!dsPharmacyRecord.Tables[0].Columns.Contains("is_client"))
                {
                    if (drTargetDiary["diary_date"].ToString() == DateTime.Now.ToString("yyyy-MM-dd"))
                    {
                        ...
                        sqlinsert.Append("(detail_id,user_id,goods_id,code_num,status,expire_date,input_time,note,is_del,source_id)");
                        sqlinsert.Append(" values ");
                        sqlinsert.Append("('" + TmoShare.NextBillNumber() + "','" + drTargetDiary["user_id"].ToString() + "','1000100','" + pointsNum + "','1','','" + datetime + "','" + GetPointsNote("1000100") + "','2','1')");
                        SQLList.Add(sqlinsert.ToString());
                        sqlinsert.Remove(0, sqlinsert.Length);
                        /*3修改积分信息*/

                        sqlinsert.Append("update  tmo_points  set ");
                        sqlinsert.Append(" code_num='" + (Convert.ToInt32(pointsNum.ToString()) + Convert.ToInt32(dspoints.Tables[0].Rows[0]["code_num"].ToString())).ToString() + "',");
                        sqlinsert.Append(" gain_num='" + (Convert.ToInt32(pointsNum.ToString()) + Convert.ToInt32(dspoints.Tables[0].Rows[0]["gain_num"].ToString())).ToString() + "',");
                        sqlinsert.Append(" update_time='" + datetime + "'");
                        sqlinsert.Append(" where user_id='" + drTargetDiary["user_id"].ToString() + "'");
                        SQLList.Add(sqlinsert.ToString());
                        sqlinsert.Remove(0, sqlinsert.Length);
        ...
        public string AddLivingDiary(DataSet dsPharmacyRecord)
        {
            ...
            DataRow drTargetDiary = dsPharmacyRecord.Tables[0].Rows[0];
            //验证今天是否添加
            string sqltoday = "select diary_date, user_id from tmo_living_diary where  user_id='" + drTargetDiary["user_id"] + "' and  diary_date='" + drTargetDiary["diary_date"] + " 00:00:00'";
            DataSet ds = MySQLHelper.Query(sqltoday);
            //if (TmoShare.DataSetIsNotEmpty(ds)) return "-3";
            //查询积分信息
            DataSet dspoints = GetPointsDate(drTargetDiary["user_id"].ToString());
            ...
            points,input_time,is_del,diary_content)");
                sqlinsert.Append(" values ");
                sqlinsert.Append("('" + Guid.NewGuid().ToString("N") + "','" + drTargetDiary["diary_date"] + "','" + drTargetDiary["user_id"]
                                   + "','" + drTargetDiary["sleep_less"] + "','" + drTargetDiary["dreaminess"] + "','" + drTargetDiary["festless_sleep"] + "','" + drTargetDiary["sleep_early"] + "','" + drTargetDiary["getup_early"] + "','" + drTargetDiary["sleep_late"] + "','"
                                   + drTargetDiary["getup_late"] + "','" + drTargetDiary["drink_attitude"] + "','" + drTargetDiary["drink_intake"] + "','" + drTargetDiary["drink_tea"] + "','" + drTargetDiary["drink_beverage"] + "','" + drTargetDiary["defecate_habit"] + "','" + drTargetDiary["loose_stool"] + "','" + drTargetDiary["dry_stool"] + "','" + drTargetDiary["hard_stool"] + "','" + drTargetDiary["defecate_time"] +
                                   "','" + drTargetDiary["smoke"] + "','" + drTargetDiary["smoke_amount"] + "','" + drTargetDiary["manager_sleep"] + "','" + drTargetDiary["manager_drink"] + "','" + drTargetDiary["manager_defecate"] + "','" + drTargetDiary["manager_nosmoke"] + "','"
                                   + drTargetDiary["manager_time"] + "','" + drTargetDiary["sleep_time"] + "','" + drTargetDiary["night_time"] + "','" + drTargetDiary["morning_time"] + "','" + drTargetDiary["nap_time"] + "','" + drTargetDiary["nap_activetime"] + "','"
                                   + drTargetDiary["nap_movingtime"] + "','" + drTargetDiary["mwater_intake"] + "','" + drTargetDiary["mwater_getup"] + "','" + drTargetDiary["mwater_breakfast"] + "','" + drTargetDiary["mwater_moning"] + "','" + drTargetDiary["mwater_lunch"] + "','"
                                   + drTargetDiary["mwater_afternoon"] + "','" + drTargetDiary["mwater_dinnerb"] + "','" + drTargetDiary["mwater_dinnera"] + "','" + drTargetDiary["mwater_gotobed"] + "','" + drTargetDiary["mdeficate_active"] + "','" + drTargetDiary["mdeficate_times"] + "','"
                ...
                if (!dsPharmacyRecord.Tables[0].Columns.Contains("is_client"))
                {
                    if (drTargetDiary["diary_date"].ToString() == DateTime.Now.ToString("yyyy-MM-dd"))
                    {
                        ...
                        sqlinsert.Append("(detail_id,user_id,goods_id,code_num,status,expire_date,input_time,note,is_del,source_id)");
                        sqlinsert.Append(" values ");
                        sqlinsert.Append("('" + TmoShare.NextBillNumber() + "','" + drTargetDiary["user_id"].ToString() + "','1000110','" + pointsNum + "','1','','" + datetime + "','" + GetPointsNote("1000110") + "','2','1')");
                        SQLList.Add(sqlinsert.ToString());
                        sqlinsert.Remove(0, sqlinsert.Length);
                        /*3修改积分信息*/
        ...
        public string BindDevice(string user_id, string device_id, string device_type)
        {
            ...
            if (TmoShare.DataSetIsEmpty(ds))
            {
                ...
                sqlinsert.Append("(detail_id,user_id,goods_id,code_num,status,expire_date,input_time,note,is_del,source_id)");
                sqlinsert.Append(" values ");
                sqlinsert.Append("('" + TmoShare.NextBillNumber() + "','" + user_id + "','1000040','" + pointsNum + "','1','','" + datetime + "','" + GetPointsNote("1000040") + "','2','1')");
                SQLList.Add(sqlinsert.ToString());
                sqlinsert.Remove(0, sqlinsert.Length);
                /*3修改积分信息*/
        ...
        public string BindMobile(string user_id, string mobile)
        {
            ...
            if (TmoShare.DataSetIsEmpty(ds) || ds.Tables[0].Rows[0]["is_bind_mobile"].ToString() != "1")
            {
                ...
                sqlinsert.Append("(detail_id,user_id,goods_id,code_num,status,expire_date,input_time,note,is_del,source_id)");
                sqlinsert.Append(" values ");
                sqlinsert.Append("('" + TmoShare.NextBillNumber() + "','" + user_id + "','1000030','" + pointsNum + "','1','','" + datetime + "','" + GetPointsNote("1000030") + "','2','1')");
                SQLList.Add(sqlinsert.ToString());
                sqlinsert.Remove(0, sqlinsert.Length);
                /*3修改积分信息*/
        ...
        public string FriendsShare(string  user_id)
        {
            ...
            sqlinsert.Append("(detail_id,user_id,goods_id,code_num,status,expire_date,input_time,note,is_del,source_id)");
            sqlinsert.Append(" values ");
            sqlinsert.Append("('" + TmoShare.NextBillNumber() + "','" + user_id + "','1000080','" + pointsNum + "','1','','" + datetime + "','" + GetPointsNote("1000080") + "','2','1')");
            SQLList.Add(sqlinsert.ToString());
            sqlinsert.Remove(0, sqlinsert.Length);
            /*3修改积分信息*/
        ...
        public bool DealShoppingChat(string detail_id, string address_id)
        {
            ...
            sqlinsert.Append("update  tmo_points  set ");
            sqlinsert.Append(" code_num='" + (Convert.ToInt32(dspoints.Tables[0].Rows[0]["code_num"].ToString()) - Convert.ToInt32(dr["code_num"].ToString())).ToString() + "',");
            sqlinsert.Append(" cost_num='" + (Convert.ToInt32(dspoints.Tables[0].Rows[0]["gain_num"].ToString()) + Convert.ToInt32(dr["code_num"].ToString())).ToString() + "',");
            sqlinsert.Append(" update_time='" + datetime + "'");
            ...
            sqlinsert.Append(" goods_num='" + (Convert.ToInt32(dsgoods.Tables[0].Rows[0]["goods_num"].ToString()) - Convert.ToInt32(dr["goods_num"].ToString())).ToString() + "'");
        ...
        {
            string sql = "select code_num,gain_num,cost_num,is_login,sign_days,input_time,update_time,is_bind_mobile,is_bind_device from tmo_points where user_id='" + user_code + "'";
        ...
        public DataSet GetAhoppingChat(DataTable dtQuery)
        {
            ...
            strSql.Append("select a.detail_id,a.goods_id,a.goods_num,a.code_num,a.note,a.input_time,b.points_num,b.goods_name,b.goods_note,b.goods_page_url  from");
        ...
        public int GetUserRank(string user_id)
        {
            ...
            strSql.Append("(SELECT a.user_id, a.account,b.code_num FROM tmo_userinfo AS a LEFT JOIN tmo_points AS b ON a.user_id = b.user_id ORDER BY b.code_num DESC) AS s, ");
            strSql.Append(" (SELECT @counter := 0) AS t ");
            string connectionString =
                      string.Format("server={0};port={1};database={2};uid={3};pwd={4};charset=utf8;Allow Zero Datetime=true;allow user variables=true;Connect Timeout=90",
        ...
        public DataSet GetPointsGoods(string goods_id)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select a.goods_id,a.goods_name,a.goods_type,a.points_num,a.goods_num,a.goods_detail,a.goods_note,a.goods_page_url,a.relation_id,b.big_type_id,b.big_type_name,b.type_id,b.type_name  from");
        ...
        public DataSet GetNurDiaryList(DataTable dtQuery)
        {
            ...
            strWhere.Append(" tmo_nur_diary as a left join tmo_userinfo as b on a.user_id=b.user_id where a.is_del!='1' and (b.doc_id is null or b.doc_id in (" + dr["doc_code"].ToString() + ")) and (b.doc_id is null or b.doc_id in (" + dr["doc_code"].ToString() + ")) ");
        ...
        public DataSet GetSportDiaryList(DataTable dtQuery)
        {
            ...
            strSql.Append(@"select a.*,b.name,'查看或修改' as 'update','删除' as del from");
            strWhere.Append(" tmo_sport_diary as a left join tmo_userinfo as b on a.user_id=b.user_id where a.is_del!='1' and (b.doc_id is null or b.doc_id in (" + dr["doc_code"].ToString() + ")) ");
        ...
        public DataSet GetTargetDiaryList(DataTable dtQuery)
        {
            ...
            strWhere.Append(" tmo_target_diary as a left join tmo_userinfo as b on a.user_id=b.user_id where a.is_del!='1' and (b.doc_id is null or b.doc_id in (" + dr["doc_code"].ToString() + ")) ");
        ...
        public DataSet GetTargetAppendList(DataTable dtQuery)
        {
            ...
            strWhere.Append(" tmo_target_append as a left join tmo_userinfo as b on a.user_id=b.user_id where a.is_del!='1' and (b.doc_id is null or b.doc_id in (" + dr["doc_code"].ToString() + ")) ");
        ...
        public DataSet GetPharmacyList(DataTable dtQuery)
        {
            ...
            strWhere.Append(" tmo_pharmacy_record as a left join tmo_userinfo as b on a.user_id=b.user_id where a.is_del!='1' and (b.doc_id is null or b.doc_id in (" + dr["doc_code"].ToString() + ")) ");
        ...
        public DataSet GetManagermentList(DataTable dtQuery)
        {
            ...
            strWhere.Append(" tmo_management as a left join tmo_userinfo as b on a.user_id=b.user_id where a.is_del!='1' and (b.doc_id is null or b.doc_id in (" + dr["doc_code"].ToString() + ")) ");
        ...
        public DataSet GetLivingList(DataTable dtQuery)
        {
            ...
            StringBuilder groupStr = new StringBuilder();
            strSql.Append(@"select a.*,b.name,'查看或修改' as 'update','删除' as del from");
            strWhere.Append(" tmo_living_diary as a left join tmo_userinfo as b on a.user_id=b.user_id where a.is_del!='1' and (b.doc_id is null or b.doc_id in (" + dr["doc_code"].ToString() + ")) ");
