   ...
   <user_id></user_id>
    <user_time></user_time>
        ...
        void DXMessageBox_btnOKClick(object sender, EventArgs e)
        {
            ...
            bool isdel = (bool)TmoReomotingClient.InvokeServerMethod(funCode.DeleteQuestionnaire, user_idstr, user_timesstr);
            if (isdel)
            {
        ...
        void btnRisk_Click(object sender, EventArgs e)
        {
            ...
            string riskDxml = TmoReomotingClient.InvokeServerMethod(funCode.GetTimes, new object[] { dr["user_id"].ToString() }).ToString();
            ...
            if (riskState != null && riskState.Tables.Count > 0 && riskState.Tables[0] != null && riskState.Tables[0].Rows.Count > 0)
            {
                if (riskState.Tables[0].Rows[0] != null && riskState.Tables[0].Rows[0]["isrisk"].ToString() == "1")
                {
                    ...
                    string strmlx = TmoReomotingClient.InvokeServerMethod(funCode.GetRiskData, new object[] { selexml }).ToString();
        ...
        public void GetData()
        {
            this.ShowWaitingPanel(() =>
            {
                ...
                try
                {
                    ...
                    string strmlx = TmoReomotingClient.InvokeServerMethod(funCode.GetPersonData, new object[] { selexml }).ToString();
