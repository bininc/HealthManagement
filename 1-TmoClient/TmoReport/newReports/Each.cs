   ...
   <user_id></user_id>
    <user_time></user_time>
        ...
        public void RefData(string userId, string user_times)
        {
            ...
            #region 隐藏
            DataSet ds = TmoCommon.TmoShare.getDataSetFromXML(TmoLinkServer.TmoReomotingClient.InvokeServerMethod(TmoCommon.funCode.GetImetData, new object[] { userId, user_times }).ToString());
