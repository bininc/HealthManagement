...
@"<tmo>
   <user_id></user_id>
    <user_time></user_time>
        ...
        {
            DataSet ds = TmoCommon.TmoShare.getDataSetFromXML(TmoLinkServer.TmoReomotingClient.InvokeServerMethodT<string>(TmoCommon.funCode.GettuiDataUser, new object[] { userId, user_times }).ToString());
