    ...
    public partial class frmtenance : DevExpress.XtraEditors.XtraForm
    {
        ...
        void btnsave_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string yundong = this.yunJianyi.Text;
                string shanshi = this.shanJianyi.Text;
                bool isSuc = (bool)TmoLinkServer.TmoReomotingClient.InvokeServerMethod(TmoCommon.funCode.SaveReportUPdate, new object[] { severce_id, bloodreason, bloodadvice, pressurereason, pressureadvice, userID, user_times, bloodlipid_reason, bloodlipid_advice, zhuanjia, genzong, jiankangshuzhi, height_advice, weight_adivce, weist_adivce, can_advice, kong_adivce, shuzhangya_adivce,yundong,shanshi});
                if (isSuc)
                {
        ...
        public void showData(DataRow dr)
        {
            ...
            */
            ...
            DataSet ds = null;
            ds = TmoCommon.TmoShare.getDataSetFromXML(TmoLinkServer.TmoReomotingClient.InvokeServerMethod(TmoCommon.funCode.GetNewFiveData, new object[] { userID, user_times }).ToString());
