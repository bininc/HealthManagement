...
<user_times></user_times>
        ...
        public void loadData(DataRow dr)
        {
            this.ShowWaitingPanel(() =>
            {
                ...
                string xmlData = TmoReomotingClient.InvokeServerMethod(funCode.GetAttach, new object[] { userid, userTime, "old" }).ToString();
                if (xmlData != "")
                {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
           ...
           if (!isupdate)
           {
               bool isscul = (bool)TmoReomotingClient.InvokeServerMethod(funCode.InsertAttach, new object[] { cont, userid, userTime });
               if (isscul)
               {
           ...
           {
               bool isscul = (bool)TmoReomotingClient.InvokeServerMethod(funCode.UpdateAttch, new object[] { atId,cont });
               if (isscul)
               {
