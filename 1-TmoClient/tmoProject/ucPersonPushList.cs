 ...
 <input_time_end></input_time_end>
        ...
        public void GetData()
        {
            this.ShowWaitingPanel(() =>
            {
                ...
                try
                {
                    ...
                    string strmlx = TmoServiceClient.InvokeServerMethodT<string>(funCode.GetPushlist, new object[] { selexml }).ToString();
        ...
        void linklook_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                bool issuc = (bool)TmoServiceClient.InvokeServerMethodT<bool>(funCode.lookPush, new object[] { idd, TmoComm.login_docInfo.doc_loginid });
                if (issuc)
                {
        ...
        private void DXMessageBox_btnOKClick(object sender, EventArgs e)
        {
            ...
            bool issuc = (bool)TmoServiceClient.InvokeServerMethodT<bool>(funCode.DelPush, new object[] { idd });
            if (issuc)
            {
