    ...
    <solve_content></solve_content>
        ...
        void gridView1_RowCellClick(object sender, DevExpress.XtraGrid.Views.Grid.RowCellClickEventArgs e)
        {
            ...
            if (e.Column.Name == "look_report")
            {
                ...
                string xmlreturn = TmoReomotingClient.InvokeServerMethod(funCode.GetProResult, new object[] { user_idd, user_timesd, "" }).ToString();
        ...
        void DXMessageBox_btnOKClick(object sender, EventArgs e)
        {
            ...
            bool issuc = (bool)TmoReomotingClient.InvokeServerMethod(funCode.DelPerProre, new object[] { user_idd, user_timesd, "" });
            if (issuc)
            {
        ...
        void ShengPro(string user_idd, string user_timesd)
        {
            this.ShowWaitingPanel(() =>
            {
                try
                {
                    ...
                    string resxml = TmoReomotingClient.InvokeServerMethod(funCode.GetRiskResult, new object[] { user_idd, user_timesd }).ToString();
                    ...
                    string resxmlprodic = TmoReomotingClient.InvokeServerMethod(funCode.GetProjectDic, new object[] { "", "", "" }).ToString();
                    ...
                    else
                    {
                        ...
                        bool isuc = (bool)TmoReomotingClient.InvokeServerMethod(funCode.InProResult, new object[] { inputproxml });
                        if (isuc)
                            return "1";
                        else
                            return "2";
        ...
        public void GetData()
        {
            ...
            this.ShowWaitingPanel(() =>
            {
                ...
                try
                {
                    ...
                    string strmlx = TmoReomotingClient.InvokeServerMethod(funCode.GetProjectData, new object[] { selexml }).ToString();
