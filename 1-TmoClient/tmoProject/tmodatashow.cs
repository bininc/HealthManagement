...
{
    public partial class tmodatashow : TmoSkin.UCBase
    {
        #region member
        int _pageSize = 100;
        int _currentPage = 1;
    ...
    <user_time></user_time>
        ...
        void gridView1_RowCellClick(object sender, DevExpress.XtraGrid.Views.Grid.RowCellClickEventArgs e)
        {
           ...
           if (e.Column.Name == "look_report")
            {
                FrmDataShow frmshow = new FrmDataShow(dr["user_id"].ToString());
                frmshow.GetData();
        ...
        public void GetData()
        {
            this.ShowWaitingPanel(() =>
            {
                ...
                try
                {
                    ...
                    string strmlx = TmoServiceClient.InvokeServerMethodT<string>(funCode.GetItemDataShow, new object[] { selexml }).ToString();
