    ...
    public partial class ucNurDic :UCBase
    {
        ...
        void repositoryItemHyperLinkEdit1_Click(object sender, EventArgs e)
        {
          DataRowView dr=  GetListRow();
            ...
            {
                bool sabool;
                sabool = (bool)TmoReomotingClient.InvokeServerMethod(funCode.DeleNurData, new object[] { dr["id"].ToString() });
             if(sabool){
        ...
        public void GetData(string parentid="0",string hotid="0")
        {
            this.ShowWaitingPanel(() =>
            {
                ...
                try
                {
                    ...
                    string strmlx = TmoReomotingClient.InvokeServerMethod(funCode.GetNurData, new object[] { parentid,hotid }).ToString();
