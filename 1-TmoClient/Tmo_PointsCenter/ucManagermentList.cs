...
{
    public partial class ucManagermentList : TmoSkin.UCBase
    {
        #region 公共
        int _pageSize = 100;
        int _currentPage = 1;
        ...
        public void GetData()
        {
            this.ShowWaitingPanel(() =>
            {
                try
                {
                    ...
                    string strmlx = TmoReomotingClient.InvokeServerMethodT<string>(funCode.GetManagermentList, new object[] { selexml }).ToString();
