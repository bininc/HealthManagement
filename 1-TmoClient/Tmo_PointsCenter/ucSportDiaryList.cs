...
{
    public partial class ucSportDiaryList : TmoSkin.UCBase
    {
        #region 公共
        int _pageSize = 100;
        int _currentPage = 1;
        ...
        public void GetData()
        {
            this.ShowWaitingPanel(() =>
            {
                try
                {
                    ...
                    string strmlx = TmoReomotingClient.InvokeServerMethodT<string>(funCode.GetSportDiaryList, new object[] { selexml }).ToString();
