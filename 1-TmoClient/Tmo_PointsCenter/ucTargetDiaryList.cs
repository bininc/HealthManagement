...
{
    public partial class ucTargetDiaryList : TmoSkin.UCBase
    {
        #region 公共
        int _pageSize = 100;
        int _currentPage = 1;
 ...
 <doc_code></doc_code>
    ...
    <date_end></date_end>  
        ...
        void gridView1_RowCellClick(object sender, DevExpress.XtraGrid.Views.Grid.RowCellClickEventArgs e)
        {
            ...
            {
                ucTargetDiaryAdd uclivingdiaryadd = new ucTargetDiaryAdd();
        ...
        public void GetData()
        {
            this.ShowWaitingPanel(() =>
            {
                try
                {
                    ...
                    string strmlx = TmoServiceClient.InvokeServerMethodT<string>(funCode.GetTargetAppendList, new object[] { selexml }).ToString();
        ...
        private void btnAddTarget_Click(object sender, EventArgs e)
        {
            ...
            ucTargetDiaryAdd da = new ucTargetDiaryAdd();
