...
{
    public partial class ucLivingDiaryList : TmoSkin.UCBase
    {
       #region 公共
        int _pageSize = 100;
        int _currentPage = 1;
 ...
 <doc_code></doc_code>
    ...
    <date_end></date_end>  
        ...
        void gridView1_RowCellClick(object sender, DevExpress.XtraGrid.Views.Grid.RowCellClickEventArgs e)
        {
            ...
            {
                ucLivingDiaryAdd uclivingdiaryadd = new ucLivingDiaryAdd();
        ...
        public void GetData()
        {
            this.ShowWaitingPanel(() =>
            {
                try
                {
                    ...
                    string strmlx = TmoReomotingClient.InvokeServerMethodT<string>(funCode.GetLivingList, new object[] { selexml }).ToString();
        ...
        private void btnAddTarget_Click(object sender, EventArgs e)
        {
            ...
            ucLivingDiaryAdd da = new ucLivingDiaryAdd();
