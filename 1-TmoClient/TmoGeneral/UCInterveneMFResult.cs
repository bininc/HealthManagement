...
{
    public partial class UCInterveneMFResult : UCModifyDataBase
    {
        public static bool IsShow { get; private set; }

        public UCInterveneMFResult()
        {
            Title = "填写面访结果";
            InitializeComponent();
        ...
        protected override bool AfterSaveButtonClick()
        {
            ...
            {
                DXMessageBox.ShowWarning2("面访描述不能为空！");
                return false;
            }
            return true;
        }
        ...
        protected override bool BeforeSubmitData(Dictionary<string, object> dicData)
        {
            ...
            {
                dicData[inte_content.Name] += "   面访结果：" + MFTxt.Text.Trim();
            }
            ...
            {
                DXMessageBox.ShowWarning2("请选择面访结果!");
                return false;
            }
