...
namespace TmoClient
{
    public partial class FormMain : FormMainBase
    {
        ...
        private void iLoginOut_ItemClick(object sender, ItemClickEventArgs e)
        {
            ...
            DXMessageBox.Show(string.Format("确定要注销用户【{0}】吗？", TmoComm.login_docInfo.doc_name), "注销用户", MessageIcon.Question, MessageButton.OKCancel, false, this);
        }
        /// <summary>
        /// 注销登录
        /// </summary>
        ...
        {
            if (new UCChangePwd().ShowDialog() == System.Windows.Forms.DialogResult.OK)
