...
{
    public partial class NewExtendServer : TmoSkin.UCBase
    {
        #region member
        int _pageSize = 100;
        int _currentPage = 1;
        ...
        public void GetData()
        {
            this.ShowWaitingPanel(() =>
            {
                ...
                try
                {
                    ...
                    string strmlx = TmoReomotingClient.InvokeServerMethod(funCode.GetNewServiceData, new object[] { selexml }).ToString();
